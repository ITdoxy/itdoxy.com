...
*Дата последнего обновления: 08.03.2026*
...
В числе прочих целей Оператор осуществляет:

- сбор обезличенной статистики посещаемости сайта с помощью сервиса **Яндекс Метрика** для анализа поведения пользователей, улучшения функционала и оптимизации работы сайта;
- использование сервиса **Рекламная сеть Яндекса (РСЯ)** для показа релевантной рекламы, что предполагает сбор данных о действиях пользователей на сайте (переходы между страницами, время на страницах, клики и др.).
...
- файлы куки, сведения о местоположении пользователя, сведения о действиях пользователя на Сайте, сведения об оборудовании пользователя, дата и время сессии.
- обезличенные сведения, собираемые сервисами Яндекс Метрика и РСЯ:
  - IP‑адрес и географическое местоположение пользователя;
  - тип устройства, версия браузера и другие технические параметры;
  - информация о действиях на сайте (пути переходов, время на страницах, взаимодействия с элементами интерфейса);
  - файлы куки, используемые для идентификации сессий и персонализации рекламы.
...
6.8. Обработка обезличенных данных с использованием сервисов Яндекс Метрика и РСЯ осуществляется **на основании явного согласия Пользователя**, выраженного путём нажатия кнопки "Принять" в баннере с уведомлением о сборе данных.

Согласие может быть отозвано в любой момент посредством направления уведомления на электронную почту admin@itdoxy.com с темой «Отзыв согласия на обработку персональных данных». При отзыве согласия Оператор прекращает передачу данных в указанные сервисы и инициирует удаление уже собранных сведений в течение 10 рабочих дней.
...
8.12. При использовании сервисов Яндекс Метрика и РСЯ действуют следующие правила:

- сбор данных начинается только после получения явного согласия Пользователя;
- данные передаются в ООО "Яндекс" для обработки на серверах, расположенных на территории РФ;
- срок хранения данных в Яндекс Метрике — не более 26 месяцев (настройка может быть скорректирована Оператором);
- файлы куки удаляются через 30 дней;
- при отзыве согласия или по истечении срока хранения данные подлежат уничтожению в соответствии с требованиями законодательства.
...
Передача обезличенных данных в ООО "Яндекс" для работы сервисов Метрика и РСЯ не является нарушением конфиденциальности, поскольку осуществляется:

- на основании согласия Пользователя;
- в рамках договорных отношений с Яндексом;
- с соблюдением требований законодательства РФ о персональных данных.

Яндекс обрабатывает полученные данные в соответствии со своей [Политикой конфиденциальности](https://yandex.ru/legal/confidential/) и [Условиями использования сервиса Яндекс Метрика](https://yandex.ru/legal/metrica_termsofuse/).
...
12.4. Пользователь подтверждает, что:

- ознакомился с порядком обработки данных сервисами Яндекс Метрика и РСЯ;
- дал согласие на сбор и обработку обезличенных данных указанными сервисами в рамках настоящей Политики;
- вправе в любой момент отозвать согласие, направив уведомление Оператору по адресу admin@itdoxy.com.
