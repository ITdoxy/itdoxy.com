...
В числе прочих целей Оператор осуществляет сбор обезличенной статистики посещаемости сайта с помощью сервиса **Яндекс Метрика** для анализа поведения пользователей, улучшения функционала и оптимизации работы сайта.
...
- обезличенные сведения, собираемые сервисом Яндекс Метрика:
  ...
  - файлы куки, используемые для идентификации сессий.
...
6.8. Обработка обезличенных данных с использованием сервиса Яндекс Метрика осуществляется **на основании явного согласия Пользователя**, выраженного путём нажатия кнопки "Принять" в баннере с уведомлением о сборе данных.
...
8.12. При использовании сервиса Яндекс Метрика действуют следующие правила:
...
Передача обезличенных данных в ООО "Яндекс" для работы сервиса Метрика не является нарушением конфиденциальности, поскольку осуществляется:
...
- ознакомился с порядком обработки данных сервисом Яндекс Метрика;
- дал согласие на сбор и обработку обезличенных данных указанным сервисом в рамках настоящей Политики;
